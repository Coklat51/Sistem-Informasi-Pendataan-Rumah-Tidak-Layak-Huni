<?php  if (!defined('AFISYNTAX')) die('LOE NGAPAIN ANJING!!!!!');
	$aColumns 		= array('judulberita', 'urlberita', 'tglberita', 'fotoberita'); 
	$sTable 		= 'infoberita';
	$join			= '';
	$sLimit 		= '';
	$sOrder			= '';
	...
	$output['aaData'][] =  array($no++.'.','<strong>'.$aRow->judulberita.'</strong>',$aRow->urlberita,$aRow->tglberita,'<img class="rounded mx-auto d-block" src="'.$base['url'].'/'.$aRow->fotoberita.'" style="width:75px"/>',
		'<div class="btn-group pull-right">
			<a class="kintilmu" href="'.$base['url'].'/'.$aRow->fotoberita.'" data-placement="bottom"></span></a>
			<a class="btn btn-xs btn-outline-primary kintilmu" id="edit" href="#" data-id="'.$aRow->judulberita.'" data-toggle="modal" 
			data-target="#myModal" data-placement="bottom" title="Ubah data"><span class="fa fa-edit"></span></a>
			<a class="btn btn-xs btn-outline-danger kintilmu" id="delete" href="#" data-id="'.$aRow->judulberita.'" data-toggle="modal"
