<?php  if (!defined('AFISYNTAX')) die('LOE NGAPAIN ANJING!!!!!');
	$aColumns 		= array('urllinkterkait', 'deskripsilink', 'fotolinkterkait'); 
	$sTable 		= 'linkterkait';
	$join			= '';
	$sLimit 		= '';
	$sOrder			= '';
	...
	$output['aaData'][] =  array($no++.'.','<strong>'.$aRow->urllinkterkait.'</strong>',$aRow->deskripsilink,'<img class="rounded mx-auto d-block" src="'.$base['url'].'/'.$aRow->fotolinkterkait.'" style="width:75px"/>',
		'<div class="btn-group pull-right">
			<a class="btn btn-xs btn-outline-primary kintilmu" id="edit" href="#" data-id="'.$aRow->urllinkterkait.'" data-toggle="modal" 
			data-target="#myModal" data-placement="bottom" title="Ubah data"><span class="fa fa-edit"></span></a>
			<a class="btn btn-xs btn-outline-danger kintilmu" id="delete" href="#" data-id="'.$aRow->urllinkterkait.'" data-toggle="modal"
