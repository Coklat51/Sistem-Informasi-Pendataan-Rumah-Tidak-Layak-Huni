...
switch(TRUE){
case file_exists('themes/topmenu.php') && file_exists('themes/footer.php') && file_exists('modul/satu/home/dashboarduser.php'):  
break;
default:
...
require('modul/satu/home/dashboarduser.php');
