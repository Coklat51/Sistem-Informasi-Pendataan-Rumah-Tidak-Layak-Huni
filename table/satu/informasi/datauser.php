<?php  if (!defined('AFISYNTAX')) die('LOE NGAPAIN ANJING!!!!!');
	$aColumns 		= array('user_name', 'user_password', 'nama_instansi', 'user_telp'); 
	$sTable 		= 'bukuuser';
	$join			= ' LEFT JOIN instrument_instansi ON instrument_instansi.kd_instansi=bukuuser.instansi';
	$sLimit 		= '';
	$sOrder			= '';
	switch(TRUE){
	...
	$output['aaData'][] =  array($no++.'.','<strong>'.$aRow->user_name.'</strong>',$aRow->user_password,$aRow->nama_instansi,telp($aRow->user_telp),
		'<div class="btn-group pull-right">
			<a class="btn btn-xs btn-outline-primary kintilmu" id="edit" href="#" data-id="'.$aRow->user_name.'" data-toggle="modal" 
			data-target="#myModal" data-placement="bottom" title="Ubah data"><span class="fa fa-edit"></span></a>
			<a class="btn btn-xs btn-outline-danger kintilmu" id="delete" href="#" data-id="'.$aRow->user_name.'" data-toggle="modal"
